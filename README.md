...
3. После этого split выполняется **по БВТ2201м, а не по отдельным примерам**.
...
- не происходит ли деградация генерации на новых prompt-БВТ2201х.
...
- split делается по БВТ2201м, а не по строкам;
